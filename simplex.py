...
# Nodes and weight values are stored in numpy matrices and handled with various methods used in this file.
...
# prime = True means the derivative of the function
...
def train_with_backprop(network, X, Y, learning_rate, epoch, print_info=True):
	...
	if print_info == True:
		for i in range(Y.shape[0]):
			print(X[[i]][0], network.forward(X[[i]].T))
